...
public class githubBranchOlusturma5 {
    private String projectPath;
    private String branchName;

    public githubBranchOlusturma5(String projectPath, String branchName) {
    ...
    public static void main(String[] args) {
        ...
        String yourBranch = "ahmet_yeni_ozellik"; // KENDİ BRANCH ADINIZI YAZIN
